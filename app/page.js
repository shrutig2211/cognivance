    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="flex items-center justify-between p-4 border-b">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl md:text-2xl font-bold">CogniMate</span>
        </div>
        <div className="flex items-center space-x-2 md:space-x-4">
          <a
            href="https://shrutig2211.github.io/porfolio/"
            target="_blank"
      ...
      <div className="flex justify-center mt-6 md:mt-8 px-4">
        <div className="flex items-center space-x-2 px-4 py-2 bg-gray-100 rounded-full">
          ...
          <span className="text-sm"> : AI-Powered Exam Prep Material Generator</span>
      ...
      <footer className="text-center py-4 md:py-6 text-gray-600 text-sm md:text-base">
        Made Sleeplessly by Shruti Ajay Gupta
      </footer>
    </div>
  );
};
